...
1. [KarabinerElements]()
    ...
    - This [link](http://brettterpstra.com/2017/06/15/a-hyper-key-with-karabiner-elements-full-instructions/) maybe to improve current setup
    - TODO: export settings out of karabiner elements. It is currently in `~/.config/karabiner/karabiner.json` though the options seem sketch currently.
...
1. [Chunkwm](https://koekeishiya.github.io/chunkwm/)
    - Auto window management. Using this, I can have automatic windows resizing to half the window size in a particular space.
